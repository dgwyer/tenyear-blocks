...
export default registerBlockType(
    'tenyear/phonefeatures',
    {
        ...
        edit: props => {
            const { attributes: { featureone, featuretwo, featurethree, featurefour, featurefive }, className, setAttributes } = props;
            return (
        ...
        save: props => {
            const { attributes: { featureone, featuretwo, featurethree, featurefour, featurefive } } = props;
            return (
                <div>
					<div class="wp-block-tenyear-phonefeatures__image">
						<img src="${jsData.image_url}" alt="Back cover" />
						<img id="background-img" src="${jsData.image.url}" alt="Back cover" />
					</div>
